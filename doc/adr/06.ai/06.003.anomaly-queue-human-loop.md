...
ConfidenceVector Cache HitAction≥ 0.95Yes or NoAuto-post instantly0.80–0.949YesAuto-post (but flag for optional review)< 0.80AnyAnomaly Queue – human required
...
Updates/replaces the pgvector embedding
Next identical transaction will be 0.999 confidence forever
